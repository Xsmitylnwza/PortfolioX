...
auth.Post("/reset-password", authHandler.ResetPassword)`,
    ...
    galleryLabels: ['Workspace loop', 'LINE OA inbox', 'Business pulse'],
    galleryDescriptions: [
      'One sidebar moves from dashboard to meetings and reusable document templates.',
      'LINE chat, unread state, quotations, and files stay on one client thread.',
      'Revenue, unpaid invoices, meetings, and active projects return to one pulse.',
    ],
